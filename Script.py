...
<b>🇮🇳 Bot नाम के नीचे अगर विज्ञापन (ads) दिखे तो उस पर क्लिक कर दे  !! click on bots banner below the name of bot </b>.\n
"""
...
✨ How to Request Dramas & Movies / ड्रामा और मूवीज़ कैसे रिक्वेस्ट करें ✨

1️⃣ Google पर सही नाम सर्च करें।
2️⃣ वह नाम English में bot/ ग्रुप में भेजें।
3️⃣ इस फ़ॉर्मैट का इस्तेमाल करें:

📌 For Series / सीरीज़ के लिए:
➤ Drama Name + S01 (S01 = Season 1, आगे के सीज़न के लिए बदलें s02 )
episode के लिए E फिर 0 फिर एपिसोड number ( eg. E01 = एपिसोड 1 )

📌 For Hindi Dramas / हिन्दी ड्रामा के लिए:
➤ Drama Name + Hindi

📌 For Movies / मूवीज़ के लिए:
➤ Movie Name + Year (उदाहरण: Joker 2019)

🚀 इन स्टेप्स को फ़ॉलो करें , और मौज करे!
</b>"""

    ABOUT_TXT = """<b>╭────[ ᴍʏ ᴅᴇᴛᴀɪʟs ]────⍟
├⍟ Mʏ Nᴀᴍᴇ : <a href=https://t.me/{}>{}</a>
├⍟ Dᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/iPapcornbotz/'>ᴏᴡɴᴇʀ</a> 
...
<b>Touch On File Name to Copy / फाइल नाम पे टच करे कॉपी हो जाएगा 👇<\b>
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/iPapcornbotz'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @IpapcornSupportbot सिर्फ पेमेंट संबंधित समस्या बताए !!
...
<b>यह एक ओपन-सोर्स प्रोजेक्ट है।

इस बॉट की सभी फ़ाइलें इंटरनेट पर पहले से उपलब्ध हैं या किसी अन्य व्यक्ति द्वारा पोस्ट की गई हैं। यह बॉट सिर्फ़ आसान खोज (सर्च) के लिए पहले से टेलीग्राम पर अपलोड की गई फ़ाइलों को इंडेक्स करता है। हम सभी कॉपीराइट क़ानूनों का सम्मान करते हैं और DMCA व EUCD का पालन करते हैं। यदि कुछ भी क़ानून के ख़िलाफ़ है तो कृपया मुझसे संपर्क करें ताकि उसे तुरंत हटा दिया जाए।
बिना कंटेंट क्रिएटर या कानूनी कॉपीराइट धारक की स्पष्ट अनुमति के डाउनलोड, स्ट्रीम, पुनरुत्पादन, साझा या उपभोग करना प्रतिबंधित है। यदि आपको लगता है कि यह बॉट आपकी बौद्धिक संपदा का उल्लंघन कर रहा है तो कृपया संबंधित चैनल से संपर्क करें ताकि हटाया जा सके। यह बॉट किसी भी कंटेंट का मालिक नहीं है, यह केवल टेलीग्राम की फ़ाइलों को इंडेक्स करता है।</b>"""
...
📌 आप आज वेरिफ़ाइड नहीं हैं, कृपया Verify पर क्लिक करें और अगली वेरिफ़िकेशन तक अनलिमिटेड एक्सेस पाएं।
...
ɴᴏᴡ ʏᴏᴜ ʜᴀᴠᴇ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ꜰᴏʀ ɴᴇxᴛ ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ.आपने पहली वेरिफ़िकेशन पूरी कर ली है ✓
अब आपके पास अगली वेरिफ़िकेशन तक अनलिमिटेड एक्सेस है। ✅
click on get files 
</i></b>"""

    SECOND_VERIFICATION_TEXT = """<b><i>👋 ʜᴇʏ {},

📌 ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪꜰɪᴇᴅ, ᴛᴀᴘ ᴏɴ ᴛʜᴇ ᴠᴇʀɪꜰʏ ʟɪɴᴋ ᴀɴᴅ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ꜰᴏʀ ᴛɪʟʟ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ.📌 आप आज वेरिफ़ाइड नहीं हैं, कृपया Verify पर क्लिक करें और अगली वेरिफ़िकेशन तक अनलिमिटेड एक्सेस पाएं।

#ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ:- 2/3 ✓

ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴅɪʀᴇᴄᴛ ꜰɪʟᴇs ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀᴋᴇ ᴘʀᴇᴍɪᴜᴍ sᴇʀᴠɪᴄᴇ (ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴠᴇʀɪꜰʏ).अगर आप सीधे फ़ाइलें चाहते हैं तो आप प्रीमियम सर्विस ले सकते हैं (प्रीमियम लेने पर वेरिफ़ाई करने की ज़रूरत नहीं होगी)। ✅</i></b>"""
